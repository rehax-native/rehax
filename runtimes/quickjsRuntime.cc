...
void QuickJsVm::evaluate(std::string script)
{
...
void QuickJsVm::setRootView(rehax::ui::fluxe::impl::View<rehax::ui::RawPtr<rehax::quickjs::QuickJsContainerData>> * view)
{
...
void QuickJsVm::setRootView(rehax::ui::appkit::impl::View<rehax::ui::RawPtr<rehax::quickjs::QuickJsContainerData>> * view)
{
    auto rootView = cppToJs(view, "View");
    auto globalContext = JS_GetGlobalObject(context);
    JS_SetPropertyStr(context, globalContext, "rootView", rootView);
